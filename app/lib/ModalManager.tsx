...
import { Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, Button, Link as NLink } from '@nextui-org/react';
...
export const ModalManager = ({ isOpen, onClose, onOpenChange, data, type }: ModalProps) => {
	if (type === 'adBlock')
		return (
