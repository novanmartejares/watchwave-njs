          ...
          <div className="fc mb-10 h-full w-full items-start justify-start">
            <div className="fc z-10 w-full items-start justify-start pt-80 sm:px-0 sm:pl-36">
              <div className="fc items-start justify-start px-5 pr-10">
                ...
                {/* details */}
                <div className="showcase_detail fr gap-3 text-lg font-medium text-white/80 md:mt-3">
                  ...
                  {movie.release_date && (
                    <>
                      ...
                      {(movie.content_rating || movie.runtime) && (
                        <span>•</span>
                      )}
                    </>
                  )}
                  {movie.content_rating && (
                    <>
                      <span className="rounded-lg border-1 border-[#a1a1a1] px-1.5">
                        {movie.content_rating}
                      </span>
                      {movie.runtime && <span>•</span>}
                    </>
                  )}
                  {movie.runtime && <span>{getProperTime(movie.runtime)}</span>}
                </div>
