...
const Navbar = () => {
  ...
  return (
    <div className="fr sm:fc fixed z-20 w-screen justify-between bg-black/20 px-5 text-2xl backdrop-blur-xl sm:h-screen sm:w-auto sm:justify-center sm:bg-transparent sm:px-10 sm:pt-0 sm:backdrop-blur-none">
      {icons.map((icon, i) => (
          ...
          {icon.link !== false ? (
            <Link
              ...
              className={`flex h-16 w-16 items-center justify-center ${
                pathname === icon.path ? "text-white" : "text-white/50"
